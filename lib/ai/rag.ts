...
const OUTPUT_CONTRACT = [
  ...
  '{"answer": "<tu respuesta para el usuario, puede incluir markdown>", "cita": "<la frase textual copiada palabra por palabra del fragmento en el que te apoyaste; string vacío si no te apoyaste en ninguno>", "motivo": "<cito | fuera_del_codigo | falta_dato | no_encontre>"}',
  "",
  "Reglas del \"motivo\" (NO se le muestra al vecino: sirve para que el equipo sepa qué mejorar):",
  "- \"cito\": te apoyaste en un fragmento y lo citaste. Va siempre que la cita no esté vacía.",
  "- \"fuera_del_codigo\": el Codigo de Planeamiento no regula el tema y se lo dijiste. Es una respuesta CORRECTA y completa, no una falla.",
  "- \"falta_dato\": el Codigo sí regula el tema, pero para responder te falta un dato que solo el vecino tiene (el más común: en qué distrito está la parcela) y se lo pediste.",
  "- \"no_encontre\": el tema le corresponde al Codigo y deberías haber encontrado con qué respaldarte, pero entre los fragmentos no estaba. ESTE es el único que se cuenta como algo que falta cargar, así que no lo uses para los tres casos de arriba.",
  "",
