...
const SYSTEM_PROMPT = [
  ...
  "",
  "2. Una propuesta SOLO cuenta si el documento propone una REGLA CONCRETA: una altura maxima, un uso permitido o prohibido, un retiro, una densidad, un procedimiento, un plazo, un indicador, una obligacion. NO son propuestas: un diagnostico ('falta infraestructura', 'hay deficit habitacional'), un principio general ('la ciudad debe ser inclusiva', 'hay que planificar con evidencia'), una critica al proceso ('la participacion fue insuficiente'), ni una descripcion de la situacion actual.",
  "",
